        ...
        <form action="{{ route('admin.bookings.update', $booking) }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="number_of_people" value="{{ old('number_of_people', $booking->number_of_people) }}" 
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="notes" rows="3" 
                              class="w-full px-4 py-2 border rounded-lg">{{ old('notes', $booking->notes) }}</textarea>
                </div>
            </div>
